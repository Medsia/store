...
namespace Store.Tests
{
    ...
    {
        [Fact]
        public void OrderItem_WithZeroCount_TrowsArgumentOutOfRangeExeption()
        {
        ...
        [Fact]
        public void OrderItem_WithNegativeCount_TrowsArgumentOutOfRangeExeption()
        {
            Assert.Throws<ArgumentOutOfRangeException>(() =>
            {
                int count = -1;
        ...
        [Fact]
        public void Count_WithPositiveValue_ThrowsArgumentOutOfRangeException()
        {
            var orderItem = new OrderItem(0, 5, 0m);
