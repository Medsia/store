...
namespace Store.Tests
{
    public class OrderTests
    {
        ...
        [Fact]
        public void TotalPrice_WithNnonEmptyItems_CalculateTotalPrice()
        {
            var order = new Order(1, new[]
            {
                new OrderItem(1, 3, 10m),
        ...
        [Fact]
        public void GetItem_WithNonExistingItem_ThrowsInvalidOperatiomException()
        {
            var order = new Order(1, new[]
           {
                new OrderItem(1, 3, 10m),
        ...
        public void AddOrUpdateItem_WithExistingItem_UpdatesCount()
        {
            var order = new Order(1, new[]
           {
            ...
            var product = new Product(1, null, new Category(1, null), null, 0m);
        ...
        public void AddOrUpdateItem_WithNonExistingItem_AddsCount()
        {
            var order = new Order(1, new[]
           {
            ...
            var product = new Product(4, null, new Category(1, null), null, 0m);
        ...
        [Fact]
        public void RemoveItem_WithNonExistingItem_ThrowsInvalidOperatiomException()
        {
            var order = new Order(1, new[]
           {
                new OrderItem(1, 3, 10m),
